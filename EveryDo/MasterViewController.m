...
{
    ToDo *ToDoToMove = self.listToDos[sourceIndexPath.row];
    [self.listToDos removeObjectAtIndex:sourceIndexPath.row];
    [self.listToDos insertObject:ToDoToMove atIndex:destinationIndexPath.row];
}
